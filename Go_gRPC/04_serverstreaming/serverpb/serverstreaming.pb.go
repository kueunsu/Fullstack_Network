...
const file_serverstreaming_proto_rawDesc = "" +
	"\n" +
	"\x15serverstreaming.proto\x12\x0fserverstreaming\"#\n" +
	"\aMessage\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\x1e\n" +
	"\x06Number\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x05R\x05value2]\n" +
	"\x0fServerStreaming\x12J\n" +
	"\x11GetServerResponse\x12\x17.serverstreaming.Number\x1a\x18.serverstreaming.Message\"\x000\x01B\x1aZ\x18serverstreaming/serverpbb\x06proto3"
