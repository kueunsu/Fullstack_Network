...
type myServiceServer struct {
	pb.UnimplementedMyServiceServer // pb. 추가
}

// (5) 서버 클래스에 원격 호출될 함수에 대한 rpc 함수를 작성함
// (5.1) proto 화일 내 정의한 rpc 함수 이름(MyFunction)에 대응하는 메서드를 작성함
...
func main() {
	...
	pb.RegisterMyServiceServer(grpcServer, &myServiceServer{}) //pb. 추가
